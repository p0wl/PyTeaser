...
def Summarize2(title, text):
	...
	#title = re.sub(r'[^\w ]', '', title) #strip special chars
	#print title
...
def score(sentences, titleWords, keywords):
	...
	for i, s in enumerate(sentences):
		...
		print '-------------------------------'
		print 'SENTENCE: ' + s
		print 'titleFeature: ' + str(titleFeature) + '	sentenceLength: ' + str(sentenceLength) + '	sentencePositionVar: ' + str(sentencePosition) + '	sbsFeature: ' + str(sbsFeature) + '	dbsFeature: ' + str(dbsFeature) + '	frequency: ' + str(frequency)
